...
//			kim.money = 0;
		  Bank kim = new Bank("김현준", "111-222-333-4444");
		  bankInfo(kim, 0, true);
			System.out.println("예금주 :" + kim.getName());
			System.out.println("계좌번호 :" + kim.getNumber());
			System.out.println("잔액 :" + kim.getMoney());
	...
	//		3만원 출금하기
		//	int out = kim.minusMoney();
			...
			Bank sim = new Bank("심청", "11-22-33-44", 50000);
			System.out.println("예금주 :" + sim.getName());
			System.out.println("계좌번호 :" + sim.getNumber());
			System.out.println("잔액: " + sim.getMoney());
		
			//심청씨가 출금 - 50000
			try {
			sim.minusMoney(-50000);
			}catch(Exception e) {
			}
			bankInfo(sim, -50000, false);
